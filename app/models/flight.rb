class Flight < JourneyItem
  ...
  def fake_date_to_demoday
    ...
    self.departure_date = "2018-10-21 07:00:00".to_datetime if "2018-05-13 09:00:00 +0000".to_datetime == departure_date
    ...
    self.arrival_date = "2018-10-21 09:20:00".to_datetime if "2018-05-13 11:20:00 +0000".to_datetime == arrival_date
  end
